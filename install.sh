...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://5ggiasinhvien.store/XrayRVIP/XrayR-Fastvnteam.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://5gsieuvip.io.vn/XrayRVIP/XrayR-Fastvnteam.zip"
    ...
    curl -o /usr/bin/XrayR -Ls https://5gsieuvip.io.vn/XrayRVIP/XrayR.sh
